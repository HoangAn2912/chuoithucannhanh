...
public function laydulieuchamcong($mach, $shiftId, $date) {
    $sql = "SELECT nguoidung.tennd,COALESCE(vaitro.tenvaitro, 'Không có') AS tenvaitro, calam.tenca, chamcong.trangthai, chamcong.ghichu, chamcong.thoigianvao
            FROM chamcong
